...
func rotateRKECertificatesFromCli(ctx *cli.Context) error {
	...
	_, _, _, _, _, err = RebuildClusterWithRotatedCertificates(context.Background(), rkeConfig, hosts.DialersOptions{}, externalFlags, rotateFlags)
	return err
}
...
func RebuildClusterWithRotatedCertificates(ctx context.Context,
	...
	rotateFlags cluster.RotateCertificatesFlags) (string, string, string, string, map[string]pki.CertificatePKI, error) {
